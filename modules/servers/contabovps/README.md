...
| **Access Hash** | Primera línea: API User (email). Segunda línea: API Password | `tu@email.com`<br>`tuPassword` |
...
| `serveraccesshash` | API User / API Password | Línea 1 = API User (email), línea 2 = API Password |
